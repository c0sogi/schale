    ...
    def from_stages(
        ...
        *,
        ...
        for stage_id in stage_ids or stage_cache.keys():
            ...
            override = server_data.get(server) if server_data else None
            resolved_rewards = list(
                override.Rewards
                if override is not None and override.Rewards is not None
                else stage.root.Rewards
            )
