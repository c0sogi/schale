...
def export_to_onnx(
    ...
    Args:
        ...
        output_path: Path for output ONNX file. Defaults to
            the shared cache's training/equipment/equipment_classifier.onnx
    ...
    Example:
        ...
        Successfully exported to the shared training cache
        Model size: 5.43 MB
    """
    ...
    if output_path is None:
        output_path = cache_directory() / "training/equipment/equipment_classifier.onnx"
...
Examples:
  ...
  python -m schale.scanner.training.export checkpoints/best_model.pth --opset 18
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Output path for ONNX file (default: shared training/equipment cache)",
    )
    parser.add_argument(
        "--opset",
        type=int,
